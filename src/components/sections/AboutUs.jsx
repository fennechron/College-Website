            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-10">
                <div className="flex flex-col md:flex-row gap-8 items-center md:items-start justify-between">
                    ...
                    <div className="w-full md:w-2/5 lg:w-1/3 flex flex-col items-center md:items-start text-center md:text-left md:pr-4">
                        <div className="w-48 h-48 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 xl:w-96 xl:h-96 rounded-full overflow-hidden border-[6px] border-slate-100 shadow-md mb-6 flex-shrink-0 relative">
