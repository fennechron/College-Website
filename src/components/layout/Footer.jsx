    ...
    return (
        <footer id="contact" className="bg-[#0f1522] pt-16 text-slate-300">
            <div className="mx-auto max-w-[1280px] px-6">
                <div className="grid gap-10 border-b border-slate-700/50 pb-12 grid-cols-1 sm:grid-cols-2 xl:grid-cols-[1.5fr_1fr_1fr_1.2fr]">
                    <div className="space-y-4">
                        <div>
                            <img src={logo} alt="CEC Logo" className="h-20 w-20 sm:h-24 sm:w-24 object-contain rounded-md bg-white p-1" />
                        </div>
                        <p className="max-w-sm text-sm sm:text-[0.95rem] leading-[1.75] text-slate-400">
                    ...
                    <div id="useful-links">
                        ...
                        <ul className="space-y-[9px]">
                            <li><Link className="text-sm sm:text-[0.95rem] text-slate-400 transition hover:text-white" to="/page/principal">Principal's Desk</Link></li>
                            <li><Link className="text-sm sm:text-[0.95rem] text-slate-400 transition hover:text-white" to="/page/board-of-governors">Board of Governors</Link></li>
                            <li><Link className="text-sm sm:text-[0.95rem] text-slate-400 transition hover:text-white" to="/page/administrative-staff">Administrative Staff</Link></li>
                            <li><Link className="text-sm sm:text-[0.95rem] text-slate-400 transition hover:text-white" to="/page/library-staff">Library Staff</Link></li>
                            <li><Link className="text-sm sm:text-[0.95rem] text-slate-400 transition hover:text-white" to="/page/campus-life">Campus Life</Link></li>
                            <li><Link className="text-sm sm:text-[0.95rem] text-slate-400 transition hover:text-white" to="/page/downloads">Downloads & Forms</Link></li>
                            <li><Link className="text-sm sm:text-[0.95rem] text-slate-400 transition hover:text-white" to="/page/contact">Contact Us</Link></li>
                            <li><Link className="text-sm sm:text-[0.95rem] text-slate-400 transition hover:text-white" to="/page/teachers">Faculty Directory</Link></li>
                        </ul>
                    </div>
                </div>
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 py-8 text-xs sm:text-sm text-slate-500 border-t border-slate-800/60">
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-6 text-left">
                        ...
                        <span className="hidden md:inline text-slate-700">The website is under development</span>
                    </div>
