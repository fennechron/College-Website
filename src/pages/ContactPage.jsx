        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-primary text-white py-24 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
                    ...
                    >
                        <h1 className="text-5xl sm:text-7xl font-display font-black uppercase tracking-tighter mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {contactOffices.map((office, i) => (
                        <motion.div
                            ...
                            className="bg-white p-10 rounded-2xl shadow-2xl border border-slate-50 hover:-translate-y-2 transition-all duration-300 group"
                        >
                            <div className="w-14 h-14 rounded-xl bg-slate-50 flex items-center justify-center mb-8 group-hover:rotate-12 transition-transform">
                                {React.cloneElement(office.icon, { size: 28 })}
                            </div>
                            <h3 className="text-2xl font-display font-black text-primary leading-tight mb-2">{office.title}</h3>
                            <p className="text-[0.7rem] font-black uppercase tracking-widest text-slate-400 mb-8">{office.person}</p>
                            
                            <div className="space-y-4">
                                <a href={`tel:${office.phone}`} className="flex items-center gap-4 text-md font-bold text-slate-600 hover:text-accent transition-colors">
                                    <Phone size={18} className="text-slate-300" /> {office.phone}
                                </a>
                                <a href={`mailto:${office.email}`} className="flex items-center gap-4 text-md font-bold text-slate-600 hover:text-accent transition-colors truncate">
                                    <Mail size={18} className="text-slate-300" /> {office.email}
                                </a>
                            </div>
                        </motion.div>
                    ))}
                ...
                <div className="grid lg:grid-cols-2 gap-20 items-start">
                    ...
                    <div className="space-y-10">
                        <div className="space-y-6">
                            ...
                            <h2 className="text-4xl font-display font-black text-primary uppercase leading-tight">
                        ...
                        <div className="bg-slate-50 p-8 rounded-3xl space-y-6">
                            <h3 className="text-xl font-display font-black text-primary uppercase">Distance to Transits</h3>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-primary p-10 rounded-[2.5rem] text-white space-y-6">
                            <h3 className="text-2xl font-display font-black uppercase">Direct Inquiry</h3>
                            <p className="text-white/60 font-medium">For specific academic or administrative queries, feel free to send us an email directly.</p>
                            <a href="mailto:principal@ceconline.edu" className="inline-flex items-center gap-3 px-8 py-4 bg-accent text-white font-black uppercase tracking-widest rounded-xl hover:bg-white hover:text-primary transition-all">
            ...
            <div className="py-24 bg-slate-50 relative overflow-hidden">
                <div className="max-w-6xl mx-auto px-6 text-center">
                    <h2 className="text-3xl font-display font-black text-primary uppercase mb-12">Connect With Us</h2>
                    <div className="flex flex-wrap justify-center gap-8">
                        {[
                            { name: 'LinkedIn', url: 'https://www.linkedin.com/school/college-of-engineering-chengannur/', icon: <Linkedin size={28} />, color: '#0077B5' },
                            { name: 'Instagram', url: 'https://www.instagram.com/cec_chengannur/', icon: <Instagram size={28} />, color: '#E4405F' },
                            { name: 'Facebook', url: '#', icon: <Facebook size={28} />, color: '#1877F2' }
                        ].map((social, i) => (
                            <motion.a
                                key={i}
                                href={social.url}
                            ...
                            >
                                <div 
                                    className="w-20 h-20 rounded-3xl bg-white shadow-xl flex items-center justify-center transition-all duration-300 group-hover:text-white"
                                ...
                                <span className="text-[0.7rem] font-black uppercase tracking-widest text-slate-400 group-hover:text-primary transition-colors">{social.name}</span>
                            </motion.a>
                        ))}
                    </div>
                </div>
